...
class InterCell
{
  ...
  public:
	...
	void set(PrimitiveVar *left, PrimitiveVar *right)
	{
		...
		local_flux.mass_flux() -= 0.5 * (alpha1_tilde * fabs(lambda1_tilde) * K1_tilde[0] + alpha2_tilde * fabs(lambda2_tilde) * K2_tilde[0] + alpha3_tilde * fabs(lambda3_tilde) * K3_tilde[0]);
		local_flux.momentum_flux() -= 0.5 * (alpha1_tilde * fabs(lambda1_tilde) * K1_tilde[1] + alpha2_tilde * fabs(lambda2_tilde) * K2_tilde[1] + alpha3_tilde * fabs(lambda3_tilde) * K3_tilde[1]);
		local_flux.energy_flux() -= 0.5 * (alpha1_tilde * fabs(lambda1_tilde) * K1_tilde[2] + alpha2_tilde * fabs(lambda2_tilde) * K2_tilde[2] + alpha3_tilde * fabs(lambda3_tilde) * K3_tilde[2]);
	}
};
